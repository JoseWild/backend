...
import { showEmpresas, showEmpresasID, showInsert, showUpdate, showDelete, showEmpresaCNPJ } from '../controllers/empresaControl.js';
...
router.get('/empresas/:cnpj', showEmpresaCNPJ) ;
